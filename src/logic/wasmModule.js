...
wasmMatches.fetchAndInstantiateWebAssembly = async function(obj){
    // console.log("fetchAndInstantiateWebAssembly")
    ...
    // console.log("fetchAndInstantiateWebAssembly1")
    // console.log(wasmMatches.setNeighbourMatchesWasm)
    // console.log(wasmMatches.heap)
